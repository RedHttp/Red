...
namespace Red
{
    ...
    public partial class RedHttpServer : IRouter
    {
        ...
        /// </summary>
        public static readonly string Version = typeof(RedHttpServer).GetTypeInfo().Assembly
        ...
        private readonly List<Func<Request, Response, Task<HandlerType>>> _middle =
            new List<Func<Request, Response, Task<HandlerType>>>();

        private readonly List<Func<Request, Response, WebSocketDialog, Task<HandlerType>>> _wsMiddle =
            new List<Func<Request, Response, WebSocketDialog, Task<HandlerType>>>();
